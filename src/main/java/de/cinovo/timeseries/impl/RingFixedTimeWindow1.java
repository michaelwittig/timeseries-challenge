...
/**
 * Optimization: Even faster variance :) thx to Michael K.
 * 
 * @author mwittig
 * 
 */
public final class RingFixedTimeWindow1 implements IFixedTimeWindow {
	 ...
	 */
	public RingFixedTimeWindow1(final long windowLength, final int maxSize, final ExpandStrategy expandStrategy) {
