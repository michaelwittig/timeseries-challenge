...
public final class Learned1_ArrayDequeIterator {
	...
	private static final Integer run(final ArrayDeque<Integer> list) {
		Integer v = null;
	...
	public static void main(final String[] args) {
		...
		System.out.println("test " + (Learned1_ArrayDequeIterator.run(list) == (Learned1.ELEMENTS - 1)));
		System.out.println("warmup...");
		for (int i = 0; i < Learned1.WARMUP_RUNS; i++) {
			Learned1_ArrayDequeIterator.run(list);
		}
